...
class Perfil extends Component {
    ...
    onFinishDeleteUser = (res) => {
        ...
        if (res.result.code === 200) {
            ...
            throw UiUtils.handledError(
                "Ocurrió un error al elminar el usuario"
            );
        }
    };
        ...
        return (
            <div>
                ...
                <div>
                    <Container fixed>
                        <UserDialog
                            show={this.state.userDialog.showing}
                            user={this.state.userDialog.user}
                            onClose={this.onCloseUserDialog}
                            onCreateUser={this.onCreateUser}
                            onModifiedUser={this.onModifiedUser}
                        />
                        <ChangePasswordDialog
                            show={this.state.showingChangePasswordDialog}
                            onClose={this.onCloseChangePasswordDialog}
                            onChangePassword={this.onChangePassword}
                        />
                        <QuestionDialog
                            show={this.state.deleteDialog.showing}
                            title="Atención"
                            message={this.state.deleteDialog.message}
                        ...
                        {Session.getUser().isAdmin && (
                            <Panel defaultExpanded header={tituloUsuarios}>
                                <TableUsers
